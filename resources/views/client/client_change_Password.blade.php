        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                ...
                <div class="card-body p-4">
                    <form action="{{route('client.password.update')}}" method="get" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="example-text-input" class="form-label">Old Password</label>
                                <input class="form-control @error('old_password') is-invaild @enderror" name="old_password" type="password" id="old_password">
                                @error('old_password')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('new_password') is-invaild @enderror" name="new_password" type="password" id="new_password">
                                @error('new_password')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
