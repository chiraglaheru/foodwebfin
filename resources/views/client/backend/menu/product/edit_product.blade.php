...
<div class="col-xl-4 col-md-6">
    <div class="form-group mb-3">
        ...
        <input class="form-control" type="text" name="name" value="{{ $product->name }}" id="example-text-input">
    </div>
</div>
...
<div class="col-xl-4 col-md-6">
    <div class="form-group mb-3">
        ...
        <input class="form-control" type="text" name="discount_price" value="{{ $product->discount_price }}" id="example-text-input">
    </div>
</div>
...
<div class="col-xl-6 col-md-6">
    <div class="form-group mb-3">
        ...
        <input class="form-control" type="text" name="size" value="{{ $product->size }}" id="example-text-input">
    </div>
</div>
...
<div class="col-xl-6 col-md-6">
    <div class="form-group mb-3">
        ...
        <input class="form-control" type="text" name="qty" value="{{ $product->qty }}" id="example-text-input">
    </div>
</div>
