...
<html lang="en">
    ...
    <head>
        ...
        <meta content="OshanaEat" name="description" />
...
<form class="mt-4 pt-2" action="{{ route('admin.password_submit') }}" method="POST">
    @csrf
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> learn   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Easy</p>
                                    </div>
                                </div>
                            </div>
                        </div>
