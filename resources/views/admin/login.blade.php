                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{ asset('assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">Admin Login</span>
                                        </a>
                                    </div>
                                                ...
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Managing orders across multiple food stalls is now effortless.
                                                            This system keeps everything organized and fas”
                                                        </h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                                    ...
                                                                    <p class="mb-0 text-white-50">Food Court Ownerr</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
