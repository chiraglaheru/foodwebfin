...
Route::post('/client/login_submit', [ClientController::class, 'ClientLoginSubmit'])->name('client.login.submit');
...
Route::middleware('admin')->group(function () {
    ...
    Route::controller(RoleController::class)->group(function(){
        Route::get('/alll/permission', 'AllPermission')->name('all.permission');
...
}); // ply the middleware properlyEnd Admin Middleware

Route::middleware(['client','status'])->group(function () {// Ap
        // Restaurant Routes
